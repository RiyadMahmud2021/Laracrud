...
<body> 
    <div class="container p-5"> 
        ...
        <form action="{{url('/storeData')}}" method="POST" class="form">
            @csrf <!--  why csrf??? -->
            ...
            Email: <input class='form-control' type="text" name="email" value="<?php //echo !empty($grp['description']) ? $grp['description']: '';?>">
